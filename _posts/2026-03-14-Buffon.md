...
<div style="width: 70%; margin: 0 auto; overflow: hidden;">
  <iframe 
    ...
    style="width: 100%; aspect-ratio: 900 / 750; border: none; display: block;"
    scrolling="no">
  </iframe>
</div>
...
Para quienes deseen explorar el experimento por sí mismos, modificar parámetros o reproducir las figuras presentadas aquí, he dejado disponible un pequeño notebook en Python en: [notebook_pi_day_buffon.ipynb](https://github.com/sierraporta/prancing-pony/blob/main/Codes/notebook_pi_day_buffon.ipynb).
