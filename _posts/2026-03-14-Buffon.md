...
![Experimento de Buffon]({{ site.baseurl }}/Figures/BuffonPi.png)
...
![Distribución de estimaciones de pi]({{ site.baseurl }}/Figures/DistriPi.png)
...
![Convergencia de la estimación de pi]({{ site.baseurl }}/Figures/ValuesPi.png)
...
<iframe 
  src="{{ site.baseurl }}/interactive/buffon_embed.html" 
  width="950" 
  height="720" 
  style="border:none;">
</iframe>
