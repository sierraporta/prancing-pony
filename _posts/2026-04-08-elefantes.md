...
<sub>“Lo esencial no es visible a simple vista.” Lo que los adultos interpretan como un sombrero es, en realidad, una boa que ha devorado un elefante: una metáfora sobre los límites de la percepción superficial y la pérdida de la imaginación interpretativa.  </sub>
</div>
...
<sub>Como en El principito, los datos rara vez dicen explícitamente lo que contienen. Lo que parece ruido o variación aleatoria puede esconder estructura: tendencia, estacionalidad o patrones latentes. La tarea del científico de datos consiste en distinguir entre ver un sombrero… o descubrir el elefante dentro de la serpiente. </sub>
</div>
